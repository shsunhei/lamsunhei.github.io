...
<div id="restau" data-role="page" data-add-back-btn="true">
	...
	<div class="ui-grid-a" id="restau_infos">	
		...
		<h3>Union Medical College Hospital</h3>
		<p><strong></strong></p>
		<p>strengths: </p>
			<ul> 
				<li>Professional</li>
		...
		<p><a href="http://www.pumch.cn/Category_2043/Index.aspx" target="_blank" rel="external" data-role="button">visit the website</a></p>
		</div>
	</div><!-- /grid-a -->
	<hr/>
	...
	<div class="ui-grid-a" id="contact_infos">	
		<div class="ui-block-a">
		<h2> Contact us</h2>
		<p>No.1 Shuaifuyuan Wangfujing Dongcheng District, Beijing,China 100730</p>
		<p>010-69156114</p>		
		</div>		
		<div class="ui-block-b">
		<img src="../resource/img/location1.jpg" alt="UMCH"/>
		</div>
	</div><!-- /grid-a -->
	<div id="contact_buttons">	
		<a href="map1.html" data-role="button" data-icon="location">Show it in Google Map</a>
		...
		if($.cookie('loginuser')==null){
			...
			if(success==false){
				...
				$.ajax({
			        ...
			        type: 'POST',
			        dataType: 'json',
			    	data:  {username: "<?php echo $loginuser; ?>", hospitalId: 1,time:<?php echo time()?>},
