...
<div id="restau" data-role="page" data-add-back-btn="true">
	...
	<div class="ui-grid-a" id="restau_infos">	
		...
		<h3>People Hospital of Peking University</h3>
		<p><strong></strong></p>
		<p>strengths: </p>
			<ul> 
				<li>Professional</li>
		...
		<p><a href="http://english.pkuph.cn//" target="_blank" rel="external" data-role="button">visit the website</a></p>
		</div>
	</div><!-- /grid-a -->
	<hr/>
	...
	<div class="ui-grid-a" id="contact_infos">	
		<div class="ui-block-a">
		<h2>Contact us</h2>
		<p>11 Xizhimen South Street, Beijing</p>
		<p>(010)88326666</p>		
		</div>		
		<div class="ui-block-b">
		<img src="../resource/img/location3.jpg" alt="UMCH"/>
		</div>
	</div><!-- /grid-a -->
	<div id="contact_buttons">	
		<a href="map3.html" data-role="button" data-icon="location">Show it in Google Map</a>
		...
		if($.cookie('loginuser')==null){
			...
			if(success==false){
				...
				$.ajax({
			        ...
			        type: 'POST',
			        dataType: 'json',
			    	data:  {username: "<?php echo $loginuser; ?>", hospitalId: 3,time:<?php echo time()?>},
